...
const char *fragment_shader_src1 = "#version 330 core\n"
                              ...
                              "vec3 diffuse = light.diffuse * (cos_theta * material.diffuse);\n"
