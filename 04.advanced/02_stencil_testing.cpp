/*
  0. This stencil test has the possibility of discarding fragments similar to depth test
  1. This test is based on a buffer called the stencil buffer that one can update during rendering
  2. 
*/
